...
TEST_F(EdgeDataWeightTest, WeightExponentialDecay) {
    ...
    const auto forward_weights = get_weights(edges.forward_cumulative_weights_exponential);
    const auto backward_weights = get_weights(edges.backward_cumulative_weights_exponential);
...
TEST_F(EdgeDataWeightTest, UpdateWeights) {
   ...
   auto original_forward = edges.forward_cumulative_weights_exponential;
   auto original_backward = edges.backward_cumulative_weights_exponential;
