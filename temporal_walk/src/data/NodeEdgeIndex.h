...
struct NodeEdgeIndex
{
    ...
    std::vector<double> outbound_forward_cumulative_weights_exponential;   // For all forward walks
    std::vector<double> outbound_backward_cumulative_weights_exponential;  // For undirected backward walks
    std::vector<double> inbound_backward_cumulative_weights_exponential;   // For directed backward walks
